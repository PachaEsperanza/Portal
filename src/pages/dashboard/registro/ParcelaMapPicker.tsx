  ...
  return (
    <div className="space-y-3">
      ...
      <div className="p-3 rounded-lg border-2 border-blue-400 bg-blue-50 text-xs text-blue-800">
        ...
        <p>La Unión Europea exige saber exactamente dónde está tu chacra para comprar tu café (Reglamento EUDR). Si no tienes GPS ahora, el técnico te ayudará a tomarlo en la próxima visita.</p>
      </div>
